...
WORKDIR /opt/ceilometer
RUN python setup.py install
RUN mkdir -p /etc/ceilometer
#RUN tox -egenconfig
RUN cp /opt/ceilometer/etc/ceilometer/*.json /etc/ceilometer
RUN cp /opt/ceilometer/etc/ceilometer/*.yaml /etc/ceilometer
RUN cp /opt/ceilometer/etc/ceilometer/ceilometer.conf.sample /etc/ceilometer/ceilometer.conf
